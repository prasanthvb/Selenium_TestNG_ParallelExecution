...
public class TextBoxTest01 extends TestBase {
	...
	public void navigateToElemenPage() {
		...
		Assert.assertTrue(contains, "User is in TextBox page");
		Log.pass("verified text box page");
	}
